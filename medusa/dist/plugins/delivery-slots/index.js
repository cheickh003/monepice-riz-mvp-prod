import { DeliverySlotService } from '../../services/slots';
import { slotCapacityService } from '../../services/slots-capacity';
export function registerDeliverySlotRoutes(app) {
...
async function listSlots(req, res) {
    try {
        const { date, startDate, endDate, includeExpress } = req.query;
...
async function reserveSlot(req, res) {
    try {
        const { cartId, slotId, userId } = req.body;
...
async function getNextAvailableSlots(req, res) {
    try {
...
async function getSlotCapacity(req, res) {
    try {
